...
>
  <h3>
    Choose pointer for selected annotations…
  </h3>
  
  <div class="container">
    <div class="column col1">
      <button class:selected={value === 'left'} on:click={() => { value = 'left'; }}>
    ...
    <div class="column col2">
      <button class:selected={value === 'up'} on:click={() => { value = 'up'; }}>
      ...
      <div class="middle-cell"></div>
      <button class:selected={value === 'down'} on:click={() => { value = 'down'; }}>
    ...
    <div class="column col3">
      <button class:selected={value === 'right'} on:click={() => { value = 'right'; }}>
